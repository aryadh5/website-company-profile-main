...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #008080;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                    <li class="nav-item <?php if($currentFile == 'halaman.php') echo 'active'; ?>">
                        <a class="nav-link" href="halaman.php">Halaman</a>
                    </li>
                    <li class="nav-item <?php if($currentFile == 'tutors.php') echo 'active'; ?>">
                        <a class="nav-link" href="tutors.php">Tutors</a>
                    </li>
                    <li class="nav-item <?php if($currentFile == 'partners.php') echo 'active'; ?>">
                        <a class="nav-link" href="partners.php">Partner</a>
                    </li>
                    <li class="nav-item <?php if($currentFile == 'info.php') echo 'active'; ?>">
                        <a class="nav-link" href="info.php">Contact</a>
                    </li>
                    <li class="nav-item <?php if($currentFile == 'members.php') echo 'active'; ?>">
                        <a class="nav-link" href="members.php">Members</a>
                    </li>
                    <li class="nav-item <?php if($currentFile == 'ganti_profile.php') echo 'active'; ?>">
                        <a class="nav-link" href="ganti_profile.php">Ganti Password</a>
                    </li>
                    <li class="nav-item <?php if($currentFile == 'logout.php') echo 'active'; ?>">
